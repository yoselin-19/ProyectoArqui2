...
public class menuDesplegable extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_recomendaciones) {
            Intent inte = new Intent(menuDesplegable.this,Recomendaciones.class);
            startActivity(inte);
        } else if (id == R.id.nav_estadisticas) {
            Intent inte = new Intent(menuDesplegable.this,Estadisticas.class);
            startActivity(inte);
        } else if (id == R.id.nav_estado) {
            Intent inte = new Intent(menuDesplegable.this,Estado_Actual.class);
            startActivity(inte);
